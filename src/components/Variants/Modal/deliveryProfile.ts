...
export type DeliveryProfile = {
  ...
  /**
   * Выбранный вариант курьерской доставки. Один и тот же выбор живёт в двух
   * местах — внутри диалога адреса и отдельным блоком в теле чекаута, — и
   * этим полем они синхронизируются. У пункта выдачи выбирать нечего.
   */
  variantId?: string
