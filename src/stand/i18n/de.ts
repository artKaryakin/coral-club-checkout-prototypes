export default {
  ...
  'stand.back': 'Zurück',
  'stand.log.link': 'Protokoll der Durchläufe',
  ...
  'thanks.log': 'Protokoll der Durchläufe',
  'thanks.notSent': 'Die Zeile hat die Tabelle nicht erreicht — senden Sie sie aus dem Protokoll erneut.',
