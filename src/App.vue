...
import Cc3InlineAltCheckout from '@/components/Variants/InlineAlt/Cc3InlineAltCheckout.vue'
...
const { route, isModal, isInline, isInlineAlt } = useStand()
...
<template>
  ...
  <Cc3InlineAltCheckout v-else-if="isInlineAlt" />
